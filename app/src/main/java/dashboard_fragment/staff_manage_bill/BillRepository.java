...
public class BillRepository {
    ...
    private static final String BILL_SELECT = "id,ngay_kham,"
            ...
            + "  medical_record_clinical(id, don_gia_luc_chi_dinh, clinical:clinical(id, ten_dich_vu)),"
            + "  medical_record_medicine(id, so_luong, don_gia_luc_ke_don, medicine:medicine(id, ten_thuoc, don_vi))"
            + ")";
    ...
    public Call<Void> updateBill(long billId, String paymentMethod, String invoiceStatus) {
        String idFilter = "eq." + billId;
        BillUpdatePayload payload = new BillUpdatePayload(paymentMethod, invoiceStatus);
