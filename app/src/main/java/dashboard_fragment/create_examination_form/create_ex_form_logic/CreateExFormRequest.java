...
public class CreateExFormRequest {
    ...
    public CreateExFormRequest(Date ngayKham, String gioDuKien, int soThuTuTrongNgay, String trieuChungBanDau, int phiKham, String trangThai, String phuongThucThanhToan) {
