...
public class PatientRepository {
    ...
    public Call<List<MedicalRecordByPatientResponse>> getMedicalRecordsByPatientId(String patientId) {
        ...
        String selectFields = "id,chan_doan_chinh,chan_doan_bo_sung,ghi_chu_lam_sang,doctor_id," +
                ...
                "medical_record_medicine(so_luong,lieu_dung,ghi_chu,tan_suat,thoi_gian,medicine(id,ten_thuoc,ham_luong,don_vi))";
